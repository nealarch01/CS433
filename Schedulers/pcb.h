...
public:
     ...
     */
    PCB(string name, unsigned int id = 0, unsigned int priority = 1, unsigned int burst_time = 0, unsigned int r_wait_time = 0, unsigned int r_turn_time = 0) {
        this->id = id;
        this->name = name;
